...
function formatSizeOrigin(size1, standard, precision) {
    ...
    if (size >= base) {
        ...
        size = ( size / Math.pow(base, n) ).toFixed(precision) * 1 + '';
    }else{
    ...
    function Plot(placeholder, data_, options_, plugins) {
            ...
            options = {
                ...
                yaxis: {
                    ...
                    tickFormatter: function(val, axis) {
                       ...
                       return formatSizeOrigin(val, 'si', 3);
                    }
                },
                xaxes: [],
                yaxes: [],
        ...
        function insertLegend() {
            ...
            for (var i = 0; i < entries.length; ++i) {
                ...
                var max = _.max(d, function(i) {if (i[1] == null){return -Infinity;}else{return i[1]}})[1];
                var min = _.min(d, function(i) {if (i[1] == null){return Infinity;}else{return i[1]}})[1];
                var sum = _.reduce(d, function(memo, i) {return memo + i[1]}, 0);
                ...
                fragments.push(
                    ...
                    '<td>' + formatSizeOrigin(min, "si", 3) + '</td>',
                    '<td>' + formatSizeOrigin(avg, "si", 3) + '</td>',
                    '<td>' + formatSizeOrigin(max, "si", 3) + '</td>'
                );
            }
            ...
            //    '<td>summary</td>',
            //    '<td>NA</td>', // last
            //    '<td>'+formatSizeOrigin(summary.min, 'si', 2)+'</td>', // min
            //    '<td>'+formatSizeOrigin(summary.sumAvg/entries.length, 'si', 2)+'</td>', // avg
            //    '<td>'+formatSizeOrigin(summary.max, 'si', 2)+'</td>', // max
            //    '</tr>'
            //);
            ...
            //var table = '<table class="table" style="font-size:smaller;color:#ACABAB;margin:0px;">' + fragments.join("") + '</table>';
            var table = '<table class="table" style="margin:0px;">' + fragments.join("") + '</table>';
            if (options.legend.container != null)
